      ...
      <div className="container-site relative z-10 px-4">
        ...
        >
          <Link href={`/artistas/${featuredArtists[0].slug}`} className="block group">
            <div className="relative overflow-hidden rounded-2xl mb-4 transition-transform duration-300 group-hover:scale-[1.02]" style={{ height: '400px' }}>
              <Image
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-8">
          ...
          >
            <Link href={`/artistas/${featuredArtists[1].slug}`} className="block group">
              <div className="relative overflow-hidden rounded-2xl bg-white mb-4 transition-transform duration-300 group-hover:scale-[1.02]" style={{ height: '300px' }}>
                <Image
